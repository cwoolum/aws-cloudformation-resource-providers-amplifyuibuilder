...
public class UpdateHandlerTest extends AbstractTestBase {
  ...
  public void handleRequest_UpdateWithoutCreate() {
    ...
    final ResourceHandlerRequest<ResourceModel> requestWithEmptyStringID = ResourceHandlerRequest.<ResourceModel>builder()
        .desiredResourceState(modelWithEmptyStringID)
        .build();

    Assertions.assertThrows(CfnNotFoundException.class, () -> handler.handleRequest(proxy, requestWithNullID, new CallbackContext(), proxyClient, logger));

    Assertions.assertThrows(CfnNotFoundException.class, () -> handler.handleRequest(proxy, requestWithEmptyStringID, new CallbackContext(), proxyClient, logger));
  }
}
